...
//select
$cquery = "SELECT Titel, Beschrijving, Zoektermen FROM Seo WHERE ID = ?";
$cid = $conn->prepare($cquery);
$cid->bind_param('i', $search_id);
$cid->execute();
$cid->bind_result($describe_title, $describe_text, $searchterms_text);
$cid->fetch();
$cid->close();
//close connection
//$conn->close();
...
<link rel="stylesheet" type="text/css" href="styles/web_style20.css">
