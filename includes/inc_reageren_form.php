...
mysql_query("INSERT INTO Meldingen (Persoon, Onderwerp, Email)
VALUES ('$naam', '$fullmessage', '$mail_from')");


$p_mail ="info@ondernemendinwelzijn.nl";
$mail_to ="info@ondernemendinwelzijn.nl";
$subject ="reactie";
$ccsubject ="reactie CC";
...
echo '<FORM method="post" action="reageren.php">
<table class="c_tab">
...
<br>Ik wil mij graag inzetten voor het project
<br><WRAP><TEXTAREA cols="60" rows="5" name="bericht" class="tekstveld"></TEXTAREA>
