...
mysql_query("UPDATE Meldingen SET Kruis ='$kruisje' WHERE ID ='$num'");
...
$result_pagc = mysql_query("SELECT COUNT(*) AS proc FROM Meldingen");
...
$result_pagf = mysql_query("SELECT * FROM Meldingen");
...
echo '<tr><td>'.$proj_pers.'</td><td>'.$proj_mail.'</td><td>'.$moddedmessage.'...</td><td><form method="post" action="deelnemers.php"><input type="hidden" name="num" value="'.$proj_id.'"><input type="text" name="kruisje" value="'.$proj_check.'"></form></td></tr>';
